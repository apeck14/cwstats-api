...
import patchUnsetNudgeChannelController from '@/controllers/guild/patch-unset-nudge-channel'
...
router.patch('/unset-nudge-channel', patchUnsetNudgeChannelController)
